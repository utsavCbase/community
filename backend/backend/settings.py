...
SECRET_KEY = "django-insecure-$lc%0f69qdfqp)iojc3l)^y76j5h@+hqbxf*rhy(**(-y+2x6h"
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',  # Specify the algorithm for encoding
    'SIGNING_KEY': 'your_secret_key_here',  # Secret key to sign the token
}
